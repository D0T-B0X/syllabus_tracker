...
class TopicsListView extends StatefulWidget {
  ...
  const TopicsListView({super.key, required this.courseCode});
                ...
                child: Row(
                  children: [
                    Expanded(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(left: 15, top: 30, bottom: 30, right: 15),
                        child: Material (
                          elevation: 7,
                                ...
                                onChanged: (val) {
                                  if(userID != null) {
                                    viewModel.toggleTopic(
                                        widget.courseCode, topic, val!, userID);
                                  }
                                }
                            ),
                          ),
